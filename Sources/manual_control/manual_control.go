...
/*
StartPositionControl Start position control using e.g. joystick input.
...
*/
func (s *ServiceImpl) StartPositionControl(
	ctx context.Context,

) (*StartPositionControlResponse, error) {
...
/*
StartAltitudeControl Start altitude control

	Requires manual control input to be sent regularly already.
	Does not require a  valid position e.g. GPS.
*/
func (s *ServiceImpl) StartAltitudeControl(
	ctx context.Context,

) (*StartAltitudeControlResponse, error) {
...
/*
SetManualControlInput Set manual control input
...
*/
func (s *ServiceImpl) SetManualControlInput(
	ctx context.Context,
	x float32,
	y float32,
	z float32,
...
) (*SetManualControlInputResponse, error) {
