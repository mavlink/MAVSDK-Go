...
type ServiceImpl struct{
    ...
    */
    ...
    func(s *ServiceImpl)SetArmedState(ctx context.Context, isArmed bool)(*SetArmedStateResponse, error){
    ...
    */
    ...
    func(s *ServiceImpl)SetFlightMode(ctx context.Context, flightMode *FlightMode )(*SetFlightModeResponse, error){
        
        request := &SetFlightModeRequest{}
    	request.FlightMode = *flightMode
