...
var file_failure_proto_goTypes = []interface{}{
...
func file_failure_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_failure_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_failure_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
