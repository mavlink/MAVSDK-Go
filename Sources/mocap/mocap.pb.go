...
func (Odometry_MavFrame) EnumDescriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{18, 0}
}
...
func (MocapResult_Result) EnumDescriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{19, 0}
}
...
type SetVisionSpeedEstimateRequest struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	VisionSpeedEstimate *VisionSpeedEstimate   `protobuf:"bytes,1,opt,name=vision_speed_estimate,json=visionSpeedEstimate,proto3" json:"vision_speed_estimate,omitempty"` // The vision speed estimate
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *SetVisionSpeedEstimateRequest) Reset() {
	*x = SetVisionSpeedEstimateRequest{}
	mi := &file_mocap_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetVisionSpeedEstimateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetVisionSpeedEstimateRequest) ProtoMessage() {}

func (x *SetVisionSpeedEstimateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mocap_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetVisionSpeedEstimateRequest.ProtoReflect.Descriptor instead.
func (*SetVisionSpeedEstimateRequest) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{2}
}

func (x *SetVisionSpeedEstimateRequest) GetVisionSpeedEstimate() *VisionSpeedEstimate {
	if x != nil {
		return x.VisionSpeedEstimate
	}
	return nil
}

type SetVisionSpeedEstimateResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MocapResult   *MocapResult           `protobuf:"bytes,1,opt,name=mocap_result,json=mocapResult,proto3" json:"mocap_result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SetVisionSpeedEstimateResponse) Reset() {
	*x = SetVisionSpeedEstimateResponse{}
	mi := &file_mocap_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetVisionSpeedEstimateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetVisionSpeedEstimateResponse) ProtoMessage() {}

func (x *SetVisionSpeedEstimateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_mocap_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetVisionSpeedEstimateResponse.ProtoReflect.Descriptor instead.
func (*SetVisionSpeedEstimateResponse) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{3}
}

func (x *SetVisionSpeedEstimateResponse) GetMocapResult() *MocapResult {
	if x != nil {
		return x.MocapResult
	}
	return nil
...
func (x *SpeedNed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpeedNed) ProtoMessage() {}

func (x *SpeedNed) ProtoReflect() protoreflect.Message {
	mi := &file_mocap_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpeedNed.ProtoReflect.Descriptor instead.
func (*SpeedNed) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{11}
}

func (x *SpeedNed) GetNorthMS() float32 {
	if x != nil {
		return x.NorthMS
	}
	return 0
...
func (x *SpeedNed) GetEastMS() float32 {
	if x != nil {
		return x.EastMS
	}
	return 0
...
func (x *SpeedNed) GetDownMS() float32 {
	if x != nil {
		return x.DownMS
	}
	return 0
...
type VisionSpeedEstimate struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	TimeUsec        uint64                 `protobuf:"varint,1,opt,name=time_usec,json=timeUsec,proto3" json:"time_usec,omitempty"`                     // Timestamp UNIX Epoch time (0 to use Backend timestamp)
	SpeedNed        *SpeedNed              `protobuf:"bytes,2,opt,name=speed_ned,json=speedNed,proto3" json:"speed_ned,omitempty"`                      // Global speed (m/s)
	SpeedCovariance *Covariance            `protobuf:"bytes,3,opt,name=speed_covariance,json=speedCovariance,proto3" json:"speed_covariance,omitempty"` // Linear velocity cross-covariance matrix.
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *VisionSpeedEstimate) Reset() {
	*x = VisionSpeedEstimate{}
	mi := &file_mocap_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VisionSpeedEstimate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VisionSpeedEstimate) ProtoMessage() {}

func (x *VisionSpeedEstimate) ProtoReflect() protoreflect.Message {
	mi := &file_mocap_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VisionSpeedEstimate.ProtoReflect.Descriptor instead.
func (*VisionSpeedEstimate) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{16}
}

func (x *VisionSpeedEstimate) GetTimeUsec() uint64 {
	if x != nil {
		return x.TimeUsec
	}
	return 0
...
func (x *VisionSpeedEstimate) GetSpeedNed() *SpeedNed {
	if x != nil {
		return x.SpeedNed
	}
	return nil
...
func (x *VisionSpeedEstimate) GetSpeedCovariance() *Covariance {
	if x != nil {
		return x.SpeedCovariance
	}
	return nil
}
...
func (x *AttitudePositionMocap) Reset() {
	*x = AttitudePositionMocap{}
	mi := &file_mocap_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttitudePositionMocap) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{17}
}
...
func (x *Odometry) Reset() {
	*x = Odometry{}
	mi := &file_mocap_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Odometry) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{18}
}
...
func (x *MocapResult) Reset() {
	*x = MocapResult{}
	mi := &file_mocap_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MocapResult) Descriptor() ([]byte, []int) {
	return file_mocap_proto_rawDescGZIP(), []int{19}
}
...
const file_mocap_proto_rawDesc = "" +
	...
	"\fmocap_result\x18\x01 \x01(\v2\x1d.mavsdk.rpc.mocap.MocapResultR\vmocapResult\"z\n" +
	"\x1dSetVisionSpeedEstimateRequest\x12Y\n" +
	"\x15vision_speed_estimate\x18\x01 \x01(\v2%.mavsdk.rpc.mocap.VisionSpeedEstimateR\x13visionSpeedEstimate\"b\n" +
	"\x1eSetVisionSpeedEstimateResponse\x12@\n" +
	...
	"\x0fpose_covariance\x18\x04 \x01(\v2\x1c.mavsdk.rpc.mocap.CovarianceR\x0eposeCovariance\"\xb4\x01\n" +
	"\x13VisionSpeedEstimate\x12\x1b\n" +
	"\ttime_usec\x18\x01 \x01(\x04R\btimeUsec\x127\n" +
	"\tspeed_ned\x18\x02 \x01(\v2\x1a.mavsdk.rpc.mocap.SpeedNedR\bspeedNed\x12G\n" +
	"\x10speed_covariance\x18\x03 \x01(\v2\x1c.mavsdk.rpc.mocap.CovarianceR\x0fspeedCovariance\"\xec\x01\n" +
	...
	"\x12RESULT_UNSUPPORTED\x10\x052\x8b\x04\n" +
	"\fMocapService\x12\x8a\x01\n" +
	"\x19SetVisionPositionEstimate\x122.mavsdk.rpc.mocap.SetVisionPositionEstimateRequest\x1a3.mavsdk.rpc.mocap.SetVisionPositionEstimateResponse\"\x04\x80\xb5\x18\x01\x12\x81\x01\n" +
	"\x16SetVisionSpeedEstimate\x12/.mavsdk.rpc.mocap.SetVisionSpeedEstimateRequest\x1a0.mavsdk.rpc.mocap.SetVisionSpeedEstimateResponse\"\x04\x80\xb5\x18\x01\x12\x87\x01\n" +
...
var file_mocap_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_mocap_proto_goTypes = []any{
	...
	(*SetVisionSpeedEstimateRequest)(nil),     // 4: mavsdk.rpc.mocap.SetVisionSpeedEstimateRequest
	(*SetVisionSpeedEstimateResponse)(nil),    // 5: mavsdk.rpc.mocap.SetVisionSpeedEstimateResponse
	(*SetAttitudePositionMocapRequest)(nil),   // 6: mavsdk.rpc.mocap.SetAttitudePositionMocapRequest
	(*SetAttitudePositionMocapResponse)(nil),  // 7: mavsdk.rpc.mocap.SetAttitudePositionMocapResponse
	(*SetOdometryRequest)(nil),                // 8: mavsdk.rpc.mocap.SetOdometryRequest
	(*SetOdometryResponse)(nil),               // 9: mavsdk.rpc.mocap.SetOdometryResponse
	(*PositionBody)(nil),                      // 10: mavsdk.rpc.mocap.PositionBody
	(*AngleBody)(nil),                         // 11: mavsdk.rpc.mocap.AngleBody
	(*SpeedBody)(nil),                         // 12: mavsdk.rpc.mocap.SpeedBody
	(*SpeedNed)(nil),                          // 13: mavsdk.rpc.mocap.SpeedNed
	(*AngularVelocityBody)(nil),               // 14: mavsdk.rpc.mocap.AngularVelocityBody
	(*Covariance)(nil),                        // 15: mavsdk.rpc.mocap.Covariance
	(*Quaternion)(nil),                        // 16: mavsdk.rpc.mocap.Quaternion
	(*VisionPositionEstimate)(nil),            // 17: mavsdk.rpc.mocap.VisionPositionEstimate
	(*VisionSpeedEstimate)(nil),               // 18: mavsdk.rpc.mocap.VisionSpeedEstimate
	(*AttitudePositionMocap)(nil),             // 19: mavsdk.rpc.mocap.AttitudePositionMocap
	(*Odometry)(nil),                          // 20: mavsdk.rpc.mocap.Odometry
	(*MocapResult)(nil),                       // 21: mavsdk.rpc.mocap.MocapResult
}
var file_mocap_proto_depIdxs = []int32{
	17, // 0: mavsdk.rpc.mocap.SetVisionPositionEstimateRequest.vision_position_estimate:type_name -> mavsdk.rpc.mocap.VisionPositionEstimate
	21, // 1: mavsdk.rpc.mocap.SetVisionPositionEstimateResponse.mocap_result:type_name -> mavsdk.rpc.mocap.MocapResult
	18, // 2: mavsdk.rpc.mocap.SetVisionSpeedEstimateRequest.vision_speed_estimate:type_name -> mavsdk.rpc.mocap.VisionSpeedEstimate
	21, // 3: mavsdk.rpc.mocap.SetVisionSpeedEstimateResponse.mocap_result:type_name -> mavsdk.rpc.mocap.MocapResult
	19, // 4: mavsdk.rpc.mocap.SetAttitudePositionMocapRequest.attitude_position_mocap:type_name -> mavsdk.rpc.mocap.AttitudePositionMocap
	21, // 5: mavsdk.rpc.mocap.SetAttitudePositionMocapResponse.mocap_result:type_name -> mavsdk.rpc.mocap.MocapResult
	20, // 6: mavsdk.rpc.mocap.SetOdometryRequest.odometry:type_name -> mavsdk.rpc.mocap.Odometry
	21, // 7: mavsdk.rpc.mocap.SetOdometryResponse.mocap_result:type_name -> mavsdk.rpc.mocap.MocapResult
	10, // 8: mavsdk.rpc.mocap.VisionPositionEstimate.position_body:type_name -> mavsdk.rpc.mocap.PositionBody
	11, // 9: mavsdk.rpc.mocap.VisionPositionEstimate.angle_body:type_name -> mavsdk.rpc.mocap.AngleBody
	15, // 10: mavsdk.rpc.mocap.VisionPositionEstimate.pose_covariance:type_name -> mavsdk.rpc.mocap.Covariance
	13, // 11: mavsdk.rpc.mocap.VisionSpeedEstimate.speed_ned:type_name -> mavsdk.rpc.mocap.SpeedNed
	15, // 12: mavsdk.rpc.mocap.VisionSpeedEstimate.speed_covariance:type_name -> mavsdk.rpc.mocap.Covariance
	16, // 13: mavsdk.rpc.mocap.AttitudePositionMocap.q:type_name -> mavsdk.rpc.mocap.Quaternion
	10, // 14: mavsdk.rpc.mocap.AttitudePositionMocap.position_body:type_name -> mavsdk.rpc.mocap.PositionBody
	15, // 15: mavsdk.rpc.mocap.AttitudePositionMocap.pose_covariance:type_name -> mavsdk.rpc.mocap.Covariance
	0,  // 16: mavsdk.rpc.mocap.Odometry.frame_id:type_name -> mavsdk.rpc.mocap.Odometry.MavFrame
	10, // 17: mavsdk.rpc.mocap.Odometry.position_body:type_name -> mavsdk.rpc.mocap.PositionBody
	16, // 18: mavsdk.rpc.mocap.Odometry.q:type_name -> mavsdk.rpc.mocap.Quaternion
	12, // 19: mavsdk.rpc.mocap.Odometry.speed_body:type_name -> mavsdk.rpc.mocap.SpeedBody
	14, // 20: mavsdk.rpc.mocap.Odometry.angular_velocity_body:type_name -> mavsdk.rpc.mocap.AngularVelocityBody
	15, // 21: mavsdk.rpc.mocap.Odometry.pose_covariance:type_name -> mavsdk.rpc.mocap.Covariance
	15, // 22: mavsdk.rpc.mocap.Odometry.velocity_covariance:type_name -> mavsdk.rpc.mocap.Covariance
	1,  // 23: mavsdk.rpc.mocap.MocapResult.result:type_name -> mavsdk.rpc.mocap.MocapResult.Result
	2,  // 24: mavsdk.rpc.mocap.MocapService.SetVisionPositionEstimate:input_type -> mavsdk.rpc.mocap.SetVisionPositionEstimateRequest
	4,  // 25: mavsdk.rpc.mocap.MocapService.SetVisionSpeedEstimate:input_type -> mavsdk.rpc.mocap.SetVisionSpeedEstimateRequest
	6,  // 26: mavsdk.rpc.mocap.MocapService.SetAttitudePositionMocap:input_type -> mavsdk.rpc.mocap.SetAttitudePositionMocapRequest
	8,  // 27: mavsdk.rpc.mocap.MocapService.SetOdometry:input_type -> mavsdk.rpc.mocap.SetOdometryRequest
	3,  // 28: mavsdk.rpc.mocap.MocapService.SetVisionPositionEstimate:output_type -> mavsdk.rpc.mocap.SetVisionPositionEstimateResponse
	5,  // 29: mavsdk.rpc.mocap.MocapService.SetVisionSpeedEstimate:output_type -> mavsdk.rpc.mocap.SetVisionSpeedEstimateResponse
	7,  // 30: mavsdk.rpc.mocap.MocapService.SetAttitudePositionMocap:output_type -> mavsdk.rpc.mocap.SetAttitudePositionMocapResponse
	9,  // 31: mavsdk.rpc.mocap.MocapService.SetOdometry:output_type -> mavsdk.rpc.mocap.SetOdometryResponse
