...
func (s *ServiceImpl) GotoLocation(latitude_deg float64, longitude_deg float64, absolute_altitude_m float32, yaw_deg float32) {
...
func (s *ServiceImpl) SetReturnToLaunchAltitude(relative_altitude_m float32) {
