...
func file_mission_raw_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mission_raw_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mission_raw_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
