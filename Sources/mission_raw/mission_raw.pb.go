...
func (MissionRawResult_Result) EnumDescriptor() ([]byte, []int) {
	return file_mission_raw_proto_rawDescGZIP(), []int{37, 0}
}
...
type IsMissionFinishedResponse struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	MissionRawResult *MissionRawResult      `protobuf:"bytes,1,opt,name=mission_raw_result,json=missionRawResult,proto3" json:"mission_raw_result,omitempty"`
	IsFinished       bool                   `protobuf:"varint,2,opt,name=is_finished,json=isFinished,proto3" json:"is_finished,omitempty"` // True if the mission is finished, false otherwise
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *IsMissionFinishedResponse) GetMissionRawResult() *MissionRawResult {
	if x != nil {
		return x.MissionRawResult
	}
	return nil
...
func (x *MissionImportData) Reset() {
	*x = MissionImportData{}
	mi := &file_mission_raw_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MissionImportData) Descriptor() ([]byte, []int) {
	return file_mission_raw_proto_rawDescGZIP(), []int{36}
}
...
func (x *MissionRawResult) Reset() {
	*x = MissionRawResult{}
	mi := &file_mission_raw_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MissionRawResult) Descriptor() ([]byte, []int) {
	return file_mission_raw_proto_rawDescGZIP(), []int{37}
}
...
const file_mission_raw_proto_rawDesc = "" +
	...
	"\x12mission_raw_result\x18\x01 \x01(\v2(.mavsdk.rpc.mission_raw.MissionRawResultR\x10missionRawResult\x12Y\n" +
	"\x13mission_import_data\x18\x02 \x01(\v2).mavsdk.rpc.mission_raw.MissionImportDataR\x11missionImportData\"\x1a\n" +
	"\x18IsMissionFinishedRequest\"\x94\x01\n" +
	"\x19IsMissionFinishedResponse\x12V\n" +
	"\x12mission_raw_result\x18\x01 \x01(\v2(.mavsdk.rpc.mission_raw.MissionRawResultR\x10missionRawResult\x12\x1f\n" +
	...
	"!RESULT_INT_MESSAGES_NOT_SUPPORTED\x10\x122\xbb\x11\n" +
	...
	"%ImportQgroundcontrolMissionFromString\x12D.mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionFromStringRequest\x1aE.mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionFromStringResponse\"\x04\x80\xb5\x18\x01\x12~\n" +
	"\x11IsMissionFinished\x120.mavsdk.rpc.mission_raw.IsMissionFinishedRequest\x1a1.mavsdk.rpc.mission_raw.IsMissionFinishedResponse\"\x04\x80\xb5\x18\x01B B\x0fMissionRawProtoZ\r.;mission_rawb\x06proto3"
...
var file_mission_raw_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_mission_raw_proto_goTypes = []any{
	...
	(*IsMissionFinishedRequest)(nil),                      // 33: mavsdk.rpc.mission_raw.IsMissionFinishedRequest
	(*IsMissionFinishedResponse)(nil),                     // 34: mavsdk.rpc.mission_raw.IsMissionFinishedResponse
	(*MissionProgress)(nil),                               // 35: mavsdk.rpc.mission_raw.MissionProgress
	(*MissionItem)(nil),                                   // 36: mavsdk.rpc.mission_raw.MissionItem
	(*MissionImportData)(nil),                             // 37: mavsdk.rpc.mission_raw.MissionImportData
	(*MissionRawResult)(nil),                              // 38: mavsdk.rpc.mission_raw.MissionRawResult
}
var file_mission_raw_proto_depIdxs = []int32{
	36, // 0: mavsdk.rpc.mission_raw.UploadMissionRequest.mission_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	38, // 1: mavsdk.rpc.mission_raw.UploadMissionResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	36, // 2: mavsdk.rpc.mission_raw.UploadGeofenceRequest.mission_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	38, // 3: mavsdk.rpc.mission_raw.UploadGeofenceResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	36, // 4: mavsdk.rpc.mission_raw.UploadRallyPointsRequest.mission_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	38, // 5: mavsdk.rpc.mission_raw.UploadRallyPointsResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	38, // 6: mavsdk.rpc.mission_raw.CancelMissionUploadResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	38, // 7: mavsdk.rpc.mission_raw.DownloadMissionResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	36, // 8: mavsdk.rpc.mission_raw.DownloadMissionResponse.mission_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	38, // 9: mavsdk.rpc.mission_raw.DownloadGeofenceResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	36, // 10: mavsdk.rpc.mission_raw.DownloadGeofenceResponse.geofence_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	38, // 11: mavsdk.rpc.mission_raw.DownloadRallypointsResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	36, // 12: mavsdk.rpc.mission_raw.DownloadRallypointsResponse.rallypoint_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	38, // 13: mavsdk.rpc.mission_raw.CancelMissionDownloadResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	38, // 14: mavsdk.rpc.mission_raw.StartMissionResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	38, // 15: mavsdk.rpc.mission_raw.PauseMissionResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	38, // 16: mavsdk.rpc.mission_raw.ClearMissionResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	38, // 17: mavsdk.rpc.mission_raw.SetCurrentMissionItemResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	35, // 18: mavsdk.rpc.mission_raw.MissionProgressResponse.mission_progress:type_name -> mavsdk.rpc.mission_raw.MissionProgress
	38, // 19: mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	37, // 20: mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionResponse.mission_import_data:type_name -> mavsdk.rpc.mission_raw.MissionImportData
	38, // 21: mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionFromStringResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	37, // 22: mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionFromStringResponse.mission_import_data:type_name -> mavsdk.rpc.mission_raw.MissionImportData
	38, // 23: mavsdk.rpc.mission_raw.IsMissionFinishedResponse.mission_raw_result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult
	36, // 24: mavsdk.rpc.mission_raw.MissionImportData.mission_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	36, // 25: mavsdk.rpc.mission_raw.MissionImportData.geofence_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	36, // 26: mavsdk.rpc.mission_raw.MissionImportData.rally_items:type_name -> mavsdk.rpc.mission_raw.MissionItem
	0,  // 27: mavsdk.rpc.mission_raw.MissionRawResult.result:type_name -> mavsdk.rpc.mission_raw.MissionRawResult.Result
	1,  // 28: mavsdk.rpc.mission_raw.MissionRawService.UploadMission:input_type -> mavsdk.rpc.mission_raw.UploadMissionRequest
	3,  // 29: mavsdk.rpc.mission_raw.MissionRawService.UploadGeofence:input_type -> mavsdk.rpc.mission_raw.UploadGeofenceRequest
	5,  // 30: mavsdk.rpc.mission_raw.MissionRawService.UploadRallyPoints:input_type -> mavsdk.rpc.mission_raw.UploadRallyPointsRequest
	7,  // 31: mavsdk.rpc.mission_raw.MissionRawService.CancelMissionUpload:input_type -> mavsdk.rpc.mission_raw.CancelMissionUploadRequest
	9,  // 32: mavsdk.rpc.mission_raw.MissionRawService.DownloadMission:input_type -> mavsdk.rpc.mission_raw.DownloadMissionRequest
	11, // 33: mavsdk.rpc.mission_raw.MissionRawService.DownloadGeofence:input_type -> mavsdk.rpc.mission_raw.DownloadGeofenceRequest
	13, // 34: mavsdk.rpc.mission_raw.MissionRawService.DownloadRallypoints:input_type -> mavsdk.rpc.mission_raw.DownloadRallypointsRequest
	15, // 35: mavsdk.rpc.mission_raw.MissionRawService.CancelMissionDownload:input_type -> mavsdk.rpc.mission_raw.CancelMissionDownloadRequest
	17, // 36: mavsdk.rpc.mission_raw.MissionRawService.StartMission:input_type -> mavsdk.rpc.mission_raw.StartMissionRequest
	19, // 37: mavsdk.rpc.mission_raw.MissionRawService.PauseMission:input_type -> mavsdk.rpc.mission_raw.PauseMissionRequest
	21, // 38: mavsdk.rpc.mission_raw.MissionRawService.ClearMission:input_type -> mavsdk.rpc.mission_raw.ClearMissionRequest
	23, // 39: mavsdk.rpc.mission_raw.MissionRawService.SetCurrentMissionItem:input_type -> mavsdk.rpc.mission_raw.SetCurrentMissionItemRequest
	25, // 40: mavsdk.rpc.mission_raw.MissionRawService.SubscribeMissionProgress:input_type -> mavsdk.rpc.mission_raw.SubscribeMissionProgressRequest
	27, // 41: mavsdk.rpc.mission_raw.MissionRawService.SubscribeMissionChanged:input_type -> mavsdk.rpc.mission_raw.SubscribeMissionChangedRequest
	29, // 42: mavsdk.rpc.mission_raw.MissionRawService.ImportQgroundcontrolMission:input_type -> mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionRequest
	31, // 43: mavsdk.rpc.mission_raw.MissionRawService.ImportQgroundcontrolMissionFromString:input_type -> mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionFromStringRequest
	33, // 44: mavsdk.rpc.mission_raw.MissionRawService.IsMissionFinished:input_type -> mavsdk.rpc.mission_raw.IsMissionFinishedRequest
	2,  // 45: mavsdk.rpc.mission_raw.MissionRawService.UploadMission:output_type -> mavsdk.rpc.mission_raw.UploadMissionResponse
	4,  // 46: mavsdk.rpc.mission_raw.MissionRawService.UploadGeofence:output_type -> mavsdk.rpc.mission_raw.UploadGeofenceResponse
	6,  // 47: mavsdk.rpc.mission_raw.MissionRawService.UploadRallyPoints:output_type -> mavsdk.rpc.mission_raw.UploadRallyPointsResponse
	8,  // 48: mavsdk.rpc.mission_raw.MissionRawService.CancelMissionUpload:output_type -> mavsdk.rpc.mission_raw.CancelMissionUploadResponse
	10, // 49: mavsdk.rpc.mission_raw.MissionRawService.DownloadMission:output_type -> mavsdk.rpc.mission_raw.DownloadMissionResponse
	12, // 50: mavsdk.rpc.mission_raw.MissionRawService.DownloadGeofence:output_type -> mavsdk.rpc.mission_raw.DownloadGeofenceResponse
	14, // 51: mavsdk.rpc.mission_raw.MissionRawService.DownloadRallypoints:output_type -> mavsdk.rpc.mission_raw.DownloadRallypointsResponse
	16, // 52: mavsdk.rpc.mission_raw.MissionRawService.CancelMissionDownload:output_type -> mavsdk.rpc.mission_raw.CancelMissionDownloadResponse
	18, // 53: mavsdk.rpc.mission_raw.MissionRawService.StartMission:output_type -> mavsdk.rpc.mission_raw.StartMissionResponse
	20, // 54: mavsdk.rpc.mission_raw.MissionRawService.PauseMission:output_type -> mavsdk.rpc.mission_raw.PauseMissionResponse
	22, // 55: mavsdk.rpc.mission_raw.MissionRawService.ClearMission:output_type -> mavsdk.rpc.mission_raw.ClearMissionResponse
	24, // 56: mavsdk.rpc.mission_raw.MissionRawService.SetCurrentMissionItem:output_type -> mavsdk.rpc.mission_raw.SetCurrentMissionItemResponse
	26, // 57: mavsdk.rpc.mission_raw.MissionRawService.SubscribeMissionProgress:output_type -> mavsdk.rpc.mission_raw.MissionProgressResponse
	28, // 58: mavsdk.rpc.mission_raw.MissionRawService.SubscribeMissionChanged:output_type -> mavsdk.rpc.mission_raw.MissionChangedResponse
	30, // 59: mavsdk.rpc.mission_raw.MissionRawService.ImportQgroundcontrolMission:output_type -> mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionResponse
	32, // 60: mavsdk.rpc.mission_raw.MissionRawService.ImportQgroundcontrolMissionFromString:output_type -> mavsdk.rpc.mission_raw.ImportQgroundcontrolMissionFromStringResponse
	34, // 61: mavsdk.rpc.mission_raw.MissionRawService.IsMissionFinished:output_type -> mavsdk.rpc.mission_raw.IsMissionFinishedResponse
