...
type ServiceImpl struct{
    ...
    */
    ...
    func(s *ServiceImpl)PublishAttitude(ctx context.Context, angle *EulerAngle , angularVelocity *AngularVelocityBody )(*PublishAttitudeResponse, error){
        
        request := &PublishAttitudeRequest{}
    	request.Angle = angle
            
        request.AngularVelocity = angularVelocity
    ...
    */
    ...
    func(s *ServiceImpl)PublishVisualFlightRulesHud(ctx context.Context, fixedWingMetrics *FixedwingMetrics )(*PublishVisualFlightRulesHudResponse, error){
        
        request := &PublishVisualFlightRulesHudRequest{}
    	request.FixedWingMetrics = fixedWingMetrics
