...
type BatteryFunction int32

const (
	BatteryFunction_BATTERY_FUNCTION_UNKNOWN    BatteryFunction = 0 // Battery function is unknown
	BatteryFunction_BATTERY_FUNCTION_ALL        BatteryFunction = 1 // Battery supports all flight systems
	BatteryFunction_BATTERY_FUNCTION_PROPULSION BatteryFunction = 2 // Battery for the propulsion system
	BatteryFunction_BATTERY_FUNCTION_AVIONICS   BatteryFunction = 3 // Avionics battery
	BatteryFunction_BATTERY_FUNCTION_PAYLOAD    BatteryFunction = 4 // Payload battery
)

// Enum value maps for BatteryFunction.
var (
	BatteryFunction_name = map[int32]string{
		0: "BATTERY_FUNCTION_UNKNOWN",
		1: "BATTERY_FUNCTION_ALL",
		2: "BATTERY_FUNCTION_PROPULSION",
		3: "BATTERY_FUNCTION_AVIONICS",
		4: "BATTERY_FUNCTION_PAYLOAD",
	}
	BatteryFunction_value = map[string]int32{
...
func (x BatteryFunction) Enum() *BatteryFunction {
	p := new(BatteryFunction)
	*p = x
	return p
}

func (x BatteryFunction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BatteryFunction) Descriptor() protoreflect.EnumDescriptor {
	return file_telemetry_proto_enumTypes[1].Descriptor()
}

func (BatteryFunction) Type() protoreflect.EnumType {
	return &file_telemetry_proto_enumTypes[1]
}

func (x BatteryFunction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BatteryFunction.Descriptor instead.
func (BatteryFunction) EnumDescriptor() ([]byte, []int) {
...
func (Odometry_MavFrame) EnumDescriptor() ([]byte, []int) {
	return file_telemetry_proto_rawDescGZIP(), []int{135, 0}
}
...
func (TelemetryResult_Result) EnumDescriptor() ([]byte, []int) {
	return file_telemetry_proto_rawDescGZIP(), []int{150, 0}
}
...
type SubscribeWindRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SubscribeWindRequest) Reset() {
	*x = SubscribeWindRequest{}
	mi := &file_telemetry_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeWindRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeWindRequest) ProtoMessage() {}

func (x *SubscribeWindRequest) ProtoReflect() protoreflect.Message {
	mi := &file_telemetry_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeWindRequest.ProtoReflect.Descriptor instead.
func (*SubscribeWindRequest) Descriptor() ([]byte, []int) {
	return file_telemetry_proto_rawDescGZIP(), []int{64}
}

type WindResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Wind          *Wind                  `protobuf:"bytes,1,opt,name=wind,proto3" json:"wind,omitempty"` // The next wind
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WindResponse) Reset() {
	*x = WindResponse{}
...
func (x *WindResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WindResponse) ProtoMessage() {}

func (x *WindResponse) ProtoReflect() protoreflect.Message {
	mi := &file_telemetry_proto_msgTypes[65]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WindResponse.ProtoReflect.Descriptor instead.
func (*WindResponse) Descriptor() ([]byte, []int) {
	return file_telemetry_proto_rawDescGZIP(), []int{65}
}

func (x *WindResponse) GetWind() *Wind {
	if x != nil {
		return x.Wind
	}
	return nil
...
type SetRateHealthRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RateHz        float64                `protobuf:"fixed64,1,opt,name=rate_hz,json=rateHz,proto3" json:"rate_hz,omitempty"` // The requested rate (in Hertz)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SetRateHealthRequest) Reset() {
	*x = SetRateHealthRequest{}
	mi := &file_telemetry_proto_msgTypes[117]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetRateHealthRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetRateHealthRequest) ProtoMessage() {}

func (x *SetRateHealthRequest) ProtoReflect() protoreflect.Message {
	mi := &file_telemetry_proto_msgTypes[117]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetRateHealthRequest.ProtoReflect.Descriptor instead.
func (*SetRateHealthRequest) Descriptor() ([]byte, []int) {
	return file_telemetry_proto_rawDescGZIP(), []int{117}
}

func (x *SetRateHealthRequest) GetRateHz() float64 {
	if x != nil {
		return x.RateHz
	}
	return 0
...
type SetRateHealthResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	TelemetryResult *TelemetryResult       `protobuf:"bytes,1,opt,name=telemetry_result,json=telemetryResult,proto3" json:"telemetry_result,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
...
func (x *SetRateHealthResponse) Reset() {
	*x = SetRateHealthResponse{}
	mi := &file_telemetry_proto_msgTypes[118]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetRateHealthResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetRateHealthResponse) ProtoMessage() {}

func (x *SetRateHealthResponse) ProtoReflect() protoreflect.Message {
	mi := &file_telemetry_proto_msgTypes[118]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetRateHealthResponse.ProtoReflect.Descriptor instead.
func (*SetRateHealthResponse) Descriptor() ([]byte, []int) {
	return file_telemetry_proto_rawDescGZIP(), []int{118}
}

func (x *SetRateHealthResponse) GetTelemetryResult() *TelemetryResult {
	if x != nil {
		return x.TelemetryResult
	}
	return nil
...
type Battery struct {
	...
	TimeRemainingS     float32                `protobuf:"fixed32,7,opt,name=time_remaining_s,json=timeRemainingS,proto3" json:"time_remaining_s,omitempty"`                                           // Estimated battery usage time remaining
	BatteryFunction    BatteryFunction        `protobuf:"varint,8,opt,name=battery_function,json=batteryFunction,proto3,enum=mavsdk.rpc.telemetry.BatteryFunction" json:"battery_function,omitempty"` // Function of the battery
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *Battery) GetTimeRemainingS() float32 {
	if x != nil {
...
func (x *Battery) GetBatteryFunction() BatteryFunction {
	if x != nil {
		return x.BatteryFunction
	}
	return BatteryFunction_BATTERY_FUNCTION_UNKNOWN
}
...
type Wind struct {
	state                         protoimpl.MessageState `protogen:"open.v1"`
	WindXNedMS                    float32                `protobuf:"fixed32,1,opt,name=wind_x_ned_m_s,json=windXNedMS,proto3" json:"wind_x_ned_m_s,omitempty"`                                                            // Wind in North (NED) direction
	WindYNedMS                    float32                `protobuf:"fixed32,2,opt,name=wind_y_ned_m_s,json=windYNedMS,proto3" json:"wind_y_ned_m_s,omitempty"`                                                            //  Wind in East (NED) direction
	WindZNedMS                    float32                `protobuf:"fixed32,3,opt,name=wind_z_ned_m_s,json=windZNedMS,proto3" json:"wind_z_ned_m_s,omitempty"`                                                            // Wind in down (NED) direction
	HorizontalVariabilityStddevMS float32                `protobuf:"fixed32,4,opt,name=horizontal_variability_stddev_m_s,json=horizontalVariabilityStddevMS,proto3" json:"horizontal_variability_stddev_m_s,omitempty"`   // Variability of wind in XY, 1-STD estimated from a 1 Hz lowpassed wind estimate
	VerticalVariabilityStddevMS   float32                `protobuf:"fixed32,5,opt,name=vertical_variability_stddev_m_s,json=verticalVariabilityStddevMS,proto3" json:"vertical_variability_stddev_m_s,omitempty"`         // Variability of wind in Z, 1-STD estimated from a 1 Hz lowpassed wind estimate
	WindAltitudeMslM              float32                `protobuf:"fixed32,6,opt,name=wind_altitude_msl_m,json=windAltitudeMslM,proto3" json:"wind_altitude_msl_m,omitempty"`                                            // Altitude (MSL) that this measurement was taken at
	HorizontalWindSpeedAccuracyMS float32                `protobuf:"fixed32,7,opt,name=horizontal_wind_speed_accuracy_m_s,json=horizontalWindSpeedAccuracyMS,proto3" json:"horizontal_wind_speed_accuracy_m_s,omitempty"` // Horizontal speed 1-STD accuracy
	VerticalWindSpeedAccuracyMS   float32                `protobuf:"fixed32,8,opt,name=vertical_wind_speed_accuracy_m_s,json=verticalWindSpeedAccuracyMS,proto3" json:"vertical_wind_speed_accuracy_m_s,omitempty"`       // Vertical speed 1-STD accuracy
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *Wind) GetWindYNedMS() float32 {
	if x != nil {
		return x.WindYNedMS
	}
	return 0
...
func (x *Wind) GetWindZNedMS() float32 {
	if x != nil {
		return x.WindZNedMS
	}
	return 0
...
func (x *Wind) GetHorizontalVariabilityStddevMS() float32 {
	if x != nil {
		return x.HorizontalVariabilityStddevMS
	}
	return 0
}

func (x *Wind) GetVerticalVariabilityStddevMS() float32 {
	if x != nil {
		return x.VerticalVariabilityStddevMS
	}
	return 0
}

func (x *Wind) GetWindAltitudeMslM() float32 {
	if x != nil {
		return x.WindAltitudeMslM
	}
	return 0
}

func (x *Wind) GetHorizontalWindSpeedAccuracyMS() float32 {
	if x != nil {
		return x.HorizontalWindSpeedAccuracyMS
	}
	return 0
}

func (x *Wind) GetVerticalWindSpeedAccuracyMS() float32 {
	if x != nil {
		return x.VerticalWindSpeedAccuracyMS
	}
	return 0
}
...
const file_telemetry_proto_rawDesc = "" +
	...
	"\baltitude\x18\x01 \x01(\v2\x1e.mavsdk.rpc.telemetry.AltitudeR\baltitude\"\x16\n" +
	"\x14SubscribeWindRequest\">\n" +
	"\fWindResponse\x12.\n" +
	"\x04wind\x18\x01 \x01(\v2\x1a.mavsdk.rpc.telemetry.WindR\x04wind\"1\n" +
	...
	"\x10telemetry_result\x18\x01 \x01(\v2%.mavsdk.rpc.telemetry.TelemetryResultR\x0ftelemetryResult\"/\n" +
	"\x14SetRateHealthRequest\x12\x17\n" +
	"\arate_hz\x18\x01 \x01(\x01R\x06rateHz\"i\n" +
	"\x15SetRateHealthResponse\x12P\n" +
	...
	"\ayaw_deg\x18\x0e \x01(\x02R\x06yawDeg\"\xa5\x03\n" +
	"\aBattery\x12\x15\n" +
	...
	"\x11remaining_percent\x18\x06 \x01(\x02B\a\x82\xb5\x18\x03NaNR\x10remainingPercent\x121\n" +
	"\x10time_remaining_s\x18\a \x01(\x02B\a\x82\xb5\x18\x03NaNR\x0etimeRemainingS\x12P\n" +
	"\x10battery_function\x18\b \x01(\x0e2%.mavsdk.rpc.telemetry.BatteryFunctionR\x0fbatteryFunction\"\xd2\x03\n" +
	"\x06Health\x12H\n" +
	...
	"\x12bottom_clearance_m\x18\x06 \x01(\x02B\a\x82\xb5\x18\x03NaNR\x10bottomClearanceM\"\x8b\x04\n" +
	"\x04Wind\x12+\n" +
	"\x0ewind_x_ned_m_s\x18\x01 \x01(\x02B\a\x82\xb5\x18\x03NaNR\n" +
	"windXNedMS\x12+\n" +
	"\x0ewind_y_ned_m_s\x18\x02 \x01(\x02B\a\x82\xb5\x18\x03NaNR\n" +
	"windYNedMS\x12+\n" +
	"\x0ewind_z_ned_m_s\x18\x03 \x01(\x02B\a\x82\xb5\x18\x03NaNR\n" +
	"windZNedMS\x12Q\n" +
	"!horizontal_variability_stddev_m_s\x18\x04 \x01(\x02B\a\x82\xb5\x18\x03NaNR\x1dhorizontalVariabilityStddevMS\x12M\n" +
	"\x1fvertical_variability_stddev_m_s\x18\x05 \x01(\x02B\a\x82\xb5\x18\x03NaNR\x1bverticalVariabilityStddevMS\x126\n" +
	"\x13wind_altitude_msl_m\x18\x06 \x01(\x02B\a\x82\xb5\x18\x03NaNR\x10windAltitudeMslM\x12R\n" +
	"\"horizontal_wind_speed_accuracy_m_s\x18\a \x01(\x02B\a\x82\xb5\x18\x03NaNR\x1dhorizontalWindSpeedAccuracyMS\x12N\n" +
	" vertical_wind_speed_accuracy_m_s\x18\b \x01(\x02B\a\x82\xb5\x18\x03NaNR\x1bverticalWindSpeedAccuracyMS\"\xb4\x02\n" +
	...
	"\x12FIX_TYPE_RTK_FIXED\x10\x06*\xa7\x01\n" +
	"\x0fBatteryFunction\x12\x1c\n" +
	"\x18BATTERY_FUNCTION_UNKNOWN\x10\x00\x12\x18\n" +
	"\x14BATTERY_FUNCTION_ALL\x10\x01\x12\x1f\n" +
	"\x1bBATTERY_FUNCTION_PROPULSION\x10\x02\x12\x1d\n" +
	"\x19BATTERY_FUNCTION_AVIONICS\x10\x03\x12\x1c\n" +
	"\x18BATTERY_FUNCTION_PAYLOAD\x10\x04*\x86\x03\n" +
	"\n" +
	"FlightMode\x12\x17\n" +
	...
	"\x11SubscribeAltitude\x12..mavsdk.rpc.telemetry.SubscribeAltitudeRequest\x1a&.mavsdk.rpc.telemetry.AltitudeResponse\"\x000\x01\x12c\n" +
	"\rSubscribeWind\x12*.mavsdk.rpc.telemetry.SubscribeWindRequest\x1a\".mavsdk.rpc.telemetry.WindResponse\"\x000\x01\x12p\n" +
...
var file_telemetry_proto_msgTypes = make([]protoimpl.MessageInfo, 151)
var file_telemetry_proto_goTypes = []any{
	...
	(FlightMode)(0),                                     // 2: mavsdk.rpc.telemetry.FlightMode
	(StatusTextType)(0),                                 // 3: mavsdk.rpc.telemetry.StatusTextType
	(LandedState)(0),                                    // 4: mavsdk.rpc.telemetry.LandedState
	(VtolState)(0),                                      // 5: mavsdk.rpc.telemetry.VtolState
	(Odometry_MavFrame)(0),                              // 6: mavsdk.rpc.telemetry.Odometry.MavFrame
	(TelemetryResult_Result)(0),                         // 7: mavsdk.rpc.telemetry.TelemetryResult.Result
	(*SubscribePositionRequest)(nil),                    // 8: mavsdk.rpc.telemetry.SubscribePositionRequest
	(*PositionResponse)(nil),                            // 9: mavsdk.rpc.telemetry.PositionResponse
	(*SubscribeHomeRequest)(nil),                        // 10: mavsdk.rpc.telemetry.SubscribeHomeRequest
	(*HomeResponse)(nil),                                // 11: mavsdk.rpc.telemetry.HomeResponse
	(*SubscribeInAirRequest)(nil),                       // 12: mavsdk.rpc.telemetry.SubscribeInAirRequest
	(*InAirResponse)(nil),                               // 13: mavsdk.rpc.telemetry.InAirResponse
	(*SubscribeLandedStateRequest)(nil),                 // 14: mavsdk.rpc.telemetry.SubscribeLandedStateRequest
	(*LandedStateResponse)(nil),                         // 15: mavsdk.rpc.telemetry.LandedStateResponse
	(*SubscribeArmedRequest)(nil),                       // 16: mavsdk.rpc.telemetry.SubscribeArmedRequest
	(*ArmedResponse)(nil),                               // 17: mavsdk.rpc.telemetry.ArmedResponse
	(*SubscribeVtolStateRequest)(nil),                   // 18: mavsdk.rpc.telemetry.SubscribeVtolStateRequest
	(*VtolStateResponse)(nil),                           // 19: mavsdk.rpc.telemetry.VtolStateResponse
	(*SubscribeAttitudeQuaternionRequest)(nil),          // 20: mavsdk.rpc.telemetry.SubscribeAttitudeQuaternionRequest
	(*AttitudeQuaternionResponse)(nil),                  // 21: mavsdk.rpc.telemetry.AttitudeQuaternionResponse
	(*SubscribeAttitudeEulerRequest)(nil),               // 22: mavsdk.rpc.telemetry.SubscribeAttitudeEulerRequest
	(*AttitudeEulerResponse)(nil),                       // 23: mavsdk.rpc.telemetry.AttitudeEulerResponse
	(*SubscribeAttitudeAngularVelocityBodyRequest)(nil), // 24: mavsdk.rpc.telemetry.SubscribeAttitudeAngularVelocityBodyRequest
	(*AttitudeAngularVelocityBodyResponse)(nil),         // 25: mavsdk.rpc.telemetry.AttitudeAngularVelocityBodyResponse
	...
	(*SubscribeRawGpsRequest)(nil),                      // 30: mavsdk.rpc.telemetry.SubscribeRawGpsRequest
	(*RawGpsResponse)(nil),                              // 31: mavsdk.rpc.telemetry.RawGpsResponse
	(*SubscribeBatteryRequest)(nil),                     // 32: mavsdk.rpc.telemetry.SubscribeBatteryRequest
	(*BatteryResponse)(nil),                             // 33: mavsdk.rpc.telemetry.BatteryResponse
	(*SubscribeFlightModeRequest)(nil),                  // 34: mavsdk.rpc.telemetry.SubscribeFlightModeRequest
	(*FlightModeResponse)(nil),                          // 35: mavsdk.rpc.telemetry.FlightModeResponse
	(*SubscribeHealthRequest)(nil),                      // 36: mavsdk.rpc.telemetry.SubscribeHealthRequest
	(*HealthResponse)(nil),                              // 37: mavsdk.rpc.telemetry.HealthResponse
	(*SubscribeRcStatusRequest)(nil),                    // 38: mavsdk.rpc.telemetry.SubscribeRcStatusRequest
	(*RcStatusResponse)(nil),                            // 39: mavsdk.rpc.telemetry.RcStatusResponse
	(*SubscribeStatusTextRequest)(nil),                  // 40: mavsdk.rpc.telemetry.SubscribeStatusTextRequest
	(*StatusTextResponse)(nil),                          // 41: mavsdk.rpc.telemetry.StatusTextResponse
	(*SubscribeActuatorControlTargetRequest)(nil),       // 42: mavsdk.rpc.telemetry.SubscribeActuatorControlTargetRequest
	(*ActuatorControlTargetResponse)(nil),               // 43: mavsdk.rpc.telemetry.ActuatorControlTargetResponse
	(*SubscribeActuatorOutputStatusRequest)(nil),        // 44: mavsdk.rpc.telemetry.SubscribeActuatorOutputStatusRequest
	(*ActuatorOutputStatusResponse)(nil),                // 45: mavsdk.rpc.telemetry.ActuatorOutputStatusResponse
	(*SubscribeOdometryRequest)(nil),                    // 46: mavsdk.rpc.telemetry.SubscribeOdometryRequest
	(*OdometryResponse)(nil),                            // 47: mavsdk.rpc.telemetry.OdometryResponse
	(*SubscribePositionVelocityNedRequest)(nil),         // 48: mavsdk.rpc.telemetry.SubscribePositionVelocityNedRequest
	(*PositionVelocityNedResponse)(nil),                 // 49: mavsdk.rpc.telemetry.PositionVelocityNedResponse
	(*SubscribeGroundTruthRequest)(nil),                 // 50: mavsdk.rpc.telemetry.SubscribeGroundTruthRequest
	(*GroundTruthResponse)(nil),                         // 51: mavsdk.rpc.telemetry.GroundTruthResponse
	(*SubscribeFixedwingMetricsRequest)(nil),            // 52: mavsdk.rpc.telemetry.SubscribeFixedwingMetricsRequest
	(*FixedwingMetricsResponse)(nil),                    // 53: mavsdk.rpc.telemetry.FixedwingMetricsResponse
	(*SubscribeImuRequest)(nil),                         // 54: mavsdk.rpc.telemetry.SubscribeImuRequest
	(*ImuResponse)(nil),                                 // 55: mavsdk.rpc.telemetry.ImuResponse
	(*SubscribeScaledImuRequest)(nil),                   // 56: mavsdk.rpc.telemetry.SubscribeScaledImuRequest
	(*ScaledImuResponse)(nil),                           // 57: mavsdk.rpc.telemetry.ScaledImuResponse
	(*SubscribeRawImuRequest)(nil),                      // 58: mavsdk.rpc.telemetry.SubscribeRawImuRequest
	(*RawImuResponse)(nil),                              // 59: mavsdk.rpc.telemetry.RawImuResponse
	(*SubscribeHealthAllOkRequest)(nil),                 // 60: mavsdk.rpc.telemetry.SubscribeHealthAllOkRequest
	(*HealthAllOkResponse)(nil),                         // 61: mavsdk.rpc.telemetry.HealthAllOkResponse
	(*SubscribeUnixEpochTimeRequest)(nil),               // 62: mavsdk.rpc.telemetry.SubscribeUnixEpochTimeRequest
	(*UnixEpochTimeResponse)(nil),                       // 63: mavsdk.rpc.telemetry.UnixEpochTimeResponse
	(*SubscribeDistanceSensorRequest)(nil),              // 64: mavsdk.rpc.telemetry.SubscribeDistanceSensorRequest
	(*DistanceSensorResponse)(nil),                      // 65: mavsdk.rpc.telemetry.DistanceSensorResponse
	(*SubscribeScaledPressureRequest)(nil),              // 66: mavsdk.rpc.telemetry.SubscribeScaledPressureRequest
	(*ScaledPressureResponse)(nil),                      // 67: mavsdk.rpc.telemetry.ScaledPressureResponse
	(*SubscribeHeadingRequest)(nil),                     // 68: mavsdk.rpc.telemetry.SubscribeHeadingRequest
	(*HeadingResponse)(nil),                             // 69: mavsdk.rpc.telemetry.HeadingResponse
	(*SubscribeAltitudeRequest)(nil),                    // 70: mavsdk.rpc.telemetry.SubscribeAltitudeRequest
	(*AltitudeResponse)(nil),                            // 71: mavsdk.rpc.telemetry.AltitudeResponse
	(*SubscribeWindRequest)(nil),                        // 72: mavsdk.rpc.telemetry.SubscribeWindRequest
	(*WindResponse)(nil),                                // 73: mavsdk.rpc.telemetry.WindResponse
	(*SetRatePositionRequest)(nil),                      // 74: mavsdk.rpc.telemetry.SetRatePositionRequest
	(*SetRatePositionResponse)(nil),                     // 75: mavsdk.rpc.telemetry.SetRatePositionResponse
	(*SetRateHomeRequest)(nil),                          // 76: mavsdk.rpc.telemetry.SetRateHomeRequest
	(*SetRateHomeResponse)(nil),                         // 77: mavsdk.rpc.telemetry.SetRateHomeResponse
	(*SetRateInAirRequest)(nil),                         // 78: mavsdk.rpc.telemetry.SetRateInAirRequest
	(*SetRateInAirResponse)(nil),                        // 79: mavsdk.rpc.telemetry.SetRateInAirResponse
	(*SetRateLandedStateRequest)(nil),                   // 80: mavsdk.rpc.telemetry.SetRateLandedStateRequest
	(*SetRateLandedStateResponse)(nil),                  // 81: mavsdk.rpc.telemetry.SetRateLandedStateResponse
	(*SetRateVtolStateRequest)(nil),                     // 82: mavsdk.rpc.telemetry.SetRateVtolStateRequest
	(*SetRateVtolStateResponse)(nil),                    // 83: mavsdk.rpc.telemetry.SetRateVtolStateResponse
	(*SetRateAttitudeEulerRequest)(nil),                 // 84: mavsdk.rpc.telemetry.SetRateAttitudeEulerRequest
	(*SetRateAttitudeEulerResponse)(nil),                // 85: mavsdk.rpc.telemetry.SetRateAttitudeEulerResponse
	(*SetRateAttitudeQuaternionRequest)(nil),            // 86: mavsdk.rpc.telemetry.SetRateAttitudeQuaternionRequest
	(*SetRateAttitudeQuaternionResponse)(nil),           // 87: mavsdk.rpc.telemetry.SetRateAttitudeQuaternionResponse
	(*SetRateAttitudeAngularVelocityBodyRequest)(nil),   // 88: mavsdk.rpc.telemetry.SetRateAttitudeAngularVelocityBodyRequest
	(*SetRateAttitudeAngularVelocityBodyResponse)(nil),  // 89: mavsdk.rpc.telemetry.SetRateAttitudeAngularVelocityBodyResponse
	(*SetRateVelocityNedRequest)(nil),                   // 90: mavsdk.rpc.telemetry.SetRateVelocityNedRequest
	(*SetRateVelocityNedResponse)(nil),                  // 91: mavsdk.rpc.telemetry.SetRateVelocityNedResponse
	(*SetRateGpsInfoRequest)(nil),                       // 92: mavsdk.rpc.telemetry.SetRateGpsInfoRequest
	(*SetRateGpsInfoResponse)(nil),                      // 93: mavsdk.rpc.telemetry.SetRateGpsInfoResponse
	(*SetRateRawGpsRequest)(nil),                        // 94: mavsdk.rpc.telemetry.SetRateRawGpsRequest
	(*SetRateBatteryRequest)(nil),                       // 95: mavsdk.rpc.telemetry.SetRateBatteryRequest
	(*SetRateBatteryResponse)(nil),                      // 96: mavsdk.rpc.telemetry.SetRateBatteryResponse
	(*SetRateRcStatusRequest)(nil),                      // 97: mavsdk.rpc.telemetry.SetRateRcStatusRequest
	(*SetRateRcStatusResponse)(nil),                     // 98: mavsdk.rpc.telemetry.SetRateRcStatusResponse
	(*SetRateActuatorControlTargetRequest)(nil),         // 99: mavsdk.rpc.telemetry.SetRateActuatorControlTargetRequest
	(*SetRateActuatorControlTargetResponse)(nil),        // 100: mavsdk.rpc.telemetry.SetRateActuatorControlTargetResponse
	(*SetRateActuatorOutputStatusRequest)(nil),          // 101: mavsdk.rpc.telemetry.SetRateActuatorOutputStatusRequest
	(*SetRateActuatorOutputStatusResponse)(nil),         // 102: mavsdk.rpc.telemetry.SetRateActuatorOutputStatusResponse
	(*SetRateOdometryRequest)(nil),                      // 103: mavsdk.rpc.telemetry.SetRateOdometryRequest
	(*SetRateOdometryResponse)(nil),                     // 104: mavsdk.rpc.telemetry.SetRateOdometryResponse
	(*SetRatePositionVelocityNedRequest)(nil),           // 105: mavsdk.rpc.telemetry.SetRatePositionVelocityNedRequest
	(*SetRatePositionVelocityNedResponse)(nil),          // 106: mavsdk.rpc.telemetry.SetRatePositionVelocityNedResponse
	(*SetRateGroundTruthRequest)(nil),                   // 107: mavsdk.rpc.telemetry.SetRateGroundTruthRequest
	(*SetRateGroundTruthResponse)(nil),                  // 108: mavsdk.rpc.telemetry.SetRateGroundTruthResponse
	(*SetRateFixedwingMetricsRequest)(nil),              // 109: mavsdk.rpc.telemetry.SetRateFixedwingMetricsRequest
	(*SetRateFixedwingMetricsResponse)(nil),             // 110: mavsdk.rpc.telemetry.SetRateFixedwingMetricsResponse
	(*SetRateImuRequest)(nil),                           // 111: mavsdk.rpc.telemetry.SetRateImuRequest
	(*SetRateImuResponse)(nil),                          // 112: mavsdk.rpc.telemetry.SetRateImuResponse
	(*SetRateScaledImuRequest)(nil),                     // 113: mavsdk.rpc.telemetry.SetRateScaledImuRequest
	(*SetRateScaledImuResponse)(nil),                    // 114: mavsdk.rpc.telemetry.SetRateScaledImuResponse
	(*SetRateRawImuRequest)(nil),                        // 115: mavsdk.rpc.telemetry.SetRateRawImuRequest
	(*SetRateRawImuResponse)(nil),                       // 116: mavsdk.rpc.telemetry.SetRateRawImuResponse
	(*SetRateUnixEpochTimeRequest)(nil),                 // 117: mavsdk.rpc.telemetry.SetRateUnixEpochTimeRequest
	(*SetRateUnixEpochTimeResponse)(nil),                // 118: mavsdk.rpc.telemetry.SetRateUnixEpochTimeResponse
	(*SetRateDistanceSensorRequest)(nil),                // 119: mavsdk.rpc.telemetry.SetRateDistanceSensorRequest
	(*SetRateDistanceSensorResponse)(nil),               // 120: mavsdk.rpc.telemetry.SetRateDistanceSensorResponse
	(*GetGpsGlobalOriginRequest)(nil),                   // 121: mavsdk.rpc.telemetry.GetGpsGlobalOriginRequest
	(*GetGpsGlobalOriginResponse)(nil),                  // 122: mavsdk.rpc.telemetry.GetGpsGlobalOriginResponse
	(*SetRateAltitudeRequest)(nil),                      // 123: mavsdk.rpc.telemetry.SetRateAltitudeRequest
	(*SetRateAltitudeResponse)(nil),                     // 124: mavsdk.rpc.telemetry.SetRateAltitudeResponse
	(*SetRateHealthRequest)(nil),                        // 125: mavsdk.rpc.telemetry.SetRateHealthRequest
	(*SetRateHealthResponse)(nil),                       // 126: mavsdk.rpc.telemetry.SetRateHealthResponse
	(*Position)(nil),                                    // 127: mavsdk.rpc.telemetry.Position
	(*Heading)(nil),                                     // 128: mavsdk.rpc.telemetry.Heading
	(*Quaternion)(nil),                                  // 129: mavsdk.rpc.telemetry.Quaternion
	(*EulerAngle)(nil),                                  // 130: mavsdk.rpc.telemetry.EulerAngle
	(*AngularVelocityBody)(nil),                         // 131: mavsdk.rpc.telemetry.AngularVelocityBody
	(*GpsInfo)(nil),                                     // 132: mavsdk.rpc.telemetry.GpsInfo
	(*RawGps)(nil),                                      // 133: mavsdk.rpc.telemetry.RawGps
	(*Battery)(nil),                                     // 134: mavsdk.rpc.telemetry.Battery
	(*Health)(nil),                                      // 135: mavsdk.rpc.telemetry.Health
	(*RcStatus)(nil),                                    // 136: mavsdk.rpc.telemetry.RcStatus
	(*StatusText)(nil),                                  // 137: mavsdk.rpc.telemetry.StatusText
	(*ActuatorControlTarget)(nil),                       // 138: mavsdk.rpc.telemetry.ActuatorControlTarget
	(*ActuatorOutputStatus)(nil),                        // 139: mavsdk.rpc.telemetry.ActuatorOutputStatus
	(*Covariance)(nil),                                  // 140: mavsdk.rpc.telemetry.Covariance
	(*VelocityBody)(nil),                                // 141: mavsdk.rpc.telemetry.VelocityBody
	(*PositionBody)(nil),                                // 142: mavsdk.rpc.telemetry.PositionBody
	(*Odometry)(nil),                                    // 143: mavsdk.rpc.telemetry.Odometry
	(*DistanceSensor)(nil),                              // 144: mavsdk.rpc.telemetry.DistanceSensor
	(*ScaledPressure)(nil),                              // 145: mavsdk.rpc.telemetry.ScaledPressure
	(*PositionNed)(nil),                                 // 146: mavsdk.rpc.telemetry.PositionNed
	(*VelocityNed)(nil),                                 // 147: mavsdk.rpc.telemetry.VelocityNed
	(*PositionVelocityNed)(nil),                         // 148: mavsdk.rpc.telemetry.PositionVelocityNed
	(*GroundTruth)(nil),                                 // 149: mavsdk.rpc.telemetry.GroundTruth
	(*FixedwingMetrics)(nil),                            // 150: mavsdk.rpc.telemetry.FixedwingMetrics
	(*AccelerationFrd)(nil),                             // 151: mavsdk.rpc.telemetry.AccelerationFrd
	(*AngularVelocityFrd)(nil),                          // 152: mavsdk.rpc.telemetry.AngularVelocityFrd
	(*MagneticFieldFrd)(nil),                            // 153: mavsdk.rpc.telemetry.MagneticFieldFrd
	(*Imu)(nil),                                         // 154: mavsdk.rpc.telemetry.Imu
	(*GpsGlobalOrigin)(nil),                             // 155: mavsdk.rpc.telemetry.GpsGlobalOrigin
	(*Altitude)(nil),                                    // 156: mavsdk.rpc.telemetry.Altitude
	(*Wind)(nil),                                        // 157: mavsdk.rpc.telemetry.Wind
	(*TelemetryResult)(nil),                             // 158: mavsdk.rpc.telemetry.TelemetryResult
}
var file_telemetry_proto_depIdxs = []int32{
	127, // 0: mavsdk.rpc.telemetry.PositionResponse.position:type_name -> mavsdk.rpc.telemetry.Position
	127, // 1: mavsdk.rpc.telemetry.HomeResponse.home:type_name -> mavsdk.rpc.telemetry.Position
	...
	129, // 4: mavsdk.rpc.telemetry.AttitudeQuaternionResponse.attitude_quaternion:type_name -> mavsdk.rpc.telemetry.Quaternion
	130, // 5: mavsdk.rpc.telemetry.AttitudeEulerResponse.attitude_euler:type_name -> mavsdk.rpc.telemetry.EulerAngle
	131, // 6: mavsdk.rpc.telemetry.AttitudeAngularVelocityBodyResponse.attitude_angular_velocity_body:type_name -> mavsdk.rpc.telemetry.AngularVelocityBody
	147, // 7: mavsdk.rpc.telemetry.VelocityNedResponse.velocity_ned:type_name -> mavsdk.rpc.telemetry.VelocityNed
	132, // 8: mavsdk.rpc.telemetry.GpsInfoResponse.gps_info:type_name -> mavsdk.rpc.telemetry.GpsInfo
	133, // 9: mavsdk.rpc.telemetry.RawGpsResponse.raw_gps:type_name -> mavsdk.rpc.telemetry.RawGps
	134, // 10: mavsdk.rpc.telemetry.BatteryResponse.battery:type_name -> mavsdk.rpc.telemetry.Battery
	2,   // 11: mavsdk.rpc.telemetry.FlightModeResponse.flight_mode:type_name -> mavsdk.rpc.telemetry.FlightMode
	135, // 12: mavsdk.rpc.telemetry.HealthResponse.health:type_name -> mavsdk.rpc.telemetry.Health
	136, // 13: mavsdk.rpc.telemetry.RcStatusResponse.rc_status:type_name -> mavsdk.rpc.telemetry.RcStatus
	137, // 14: mavsdk.rpc.telemetry.StatusTextResponse.status_text:type_name -> mavsdk.rpc.telemetry.StatusText
	138, // 15: mavsdk.rpc.telemetry.ActuatorControlTargetResponse.actuator_control_target:type_name -> mavsdk.rpc.telemetry.ActuatorControlTarget
	139, // 16: mavsdk.rpc.telemetry.ActuatorOutputStatusResponse.actuator_output_status:type_name -> mavsdk.rpc.telemetry.ActuatorOutputStatus
	143, // 17: mavsdk.rpc.telemetry.OdometryResponse.odometry:type_name -> mavsdk.rpc.telemetry.Odometry
	148, // 18: mavsdk.rpc.telemetry.PositionVelocityNedResponse.position_velocity_ned:type_name -> mavsdk.rpc.telemetry.PositionVelocityNed
	149, // 19: mavsdk.rpc.telemetry.GroundTruthResponse.ground_truth:type_name -> mavsdk.rpc.telemetry.GroundTruth
	150, // 20: mavsdk.rpc.telemetry.FixedwingMetricsResponse.fixedwing_metrics:type_name -> mavsdk.rpc.telemetry.FixedwingMetrics
	154, // 21: mavsdk.rpc.telemetry.ImuResponse.imu:type_name -> mavsdk.rpc.telemetry.Imu
	154, // 22: mavsdk.rpc.telemetry.ScaledImuResponse.imu:type_name -> mavsdk.rpc.telemetry.Imu
	154, // 23: mavsdk.rpc.telemetry.RawImuResponse.imu:type_name -> mavsdk.rpc.telemetry.Imu
	144, // 24: mavsdk.rpc.telemetry.DistanceSensorResponse.distance_sensor:type_name -> mavsdk.rpc.telemetry.DistanceSensor
	145, // 25: mavsdk.rpc.telemetry.ScaledPressureResponse.scaled_pressure:type_name -> mavsdk.rpc.telemetry.ScaledPressure
	128, // 26: mavsdk.rpc.telemetry.HeadingResponse.heading_deg:type_name -> mavsdk.rpc.telemetry.Heading
	156, // 27: mavsdk.rpc.telemetry.AltitudeResponse.altitude:type_name -> mavsdk.rpc.telemetry.Altitude
	157, // 28: mavsdk.rpc.telemetry.WindResponse.wind:type_name -> mavsdk.rpc.telemetry.Wind
	158, // 29: mavsdk.rpc.telemetry.SetRatePositionResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 30: mavsdk.rpc.telemetry.SetRateHomeResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 31: mavsdk.rpc.telemetry.SetRateInAirResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 32: mavsdk.rpc.telemetry.SetRateLandedStateResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 33: mavsdk.rpc.telemetry.SetRateVtolStateResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 34: mavsdk.rpc.telemetry.SetRateAttitudeEulerResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 35: mavsdk.rpc.telemetry.SetRateAttitudeQuaternionResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 36: mavsdk.rpc.telemetry.SetRateAttitudeAngularVelocityBodyResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 37: mavsdk.rpc.telemetry.SetRateVelocityNedResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 38: mavsdk.rpc.telemetry.SetRateGpsInfoResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 39: mavsdk.rpc.telemetry.SetRateBatteryResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 40: mavsdk.rpc.telemetry.SetRateRcStatusResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 41: mavsdk.rpc.telemetry.SetRateActuatorControlTargetResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 42: mavsdk.rpc.telemetry.SetRateActuatorOutputStatusResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 43: mavsdk.rpc.telemetry.SetRateOdometryResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 44: mavsdk.rpc.telemetry.SetRatePositionVelocityNedResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 45: mavsdk.rpc.telemetry.SetRateGroundTruthResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 46: mavsdk.rpc.telemetry.SetRateFixedwingMetricsResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 47: mavsdk.rpc.telemetry.SetRateImuResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 48: mavsdk.rpc.telemetry.SetRateScaledImuResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 49: mavsdk.rpc.telemetry.SetRateRawImuResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 50: mavsdk.rpc.telemetry.SetRateUnixEpochTimeResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 51: mavsdk.rpc.telemetry.SetRateDistanceSensorResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 52: mavsdk.rpc.telemetry.GetGpsGlobalOriginResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	155, // 53: mavsdk.rpc.telemetry.GetGpsGlobalOriginResponse.gps_global_origin:type_name -> mavsdk.rpc.telemetry.GpsGlobalOrigin
	158, // 54: mavsdk.rpc.telemetry.SetRateAltitudeResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	158, // 55: mavsdk.rpc.telemetry.SetRateHealthResponse.telemetry_result:type_name -> mavsdk.rpc.telemetry.TelemetryResult
	0,   // 56: mavsdk.rpc.telemetry.GpsInfo.fix_type:type_name -> mavsdk.rpc.telemetry.FixType
	1,   // 57: mavsdk.rpc.telemetry.Battery.battery_function:type_name -> mavsdk.rpc.telemetry.BatteryFunction
	3,   // 58: mavsdk.rpc.telemetry.StatusText.type:type_name -> mavsdk.rpc.telemetry.StatusTextType
	6,   // 59: mavsdk.rpc.telemetry.Odometry.frame_id:type_name -> mavsdk.rpc.telemetry.Odometry.MavFrame
	6,   // 60: mavsdk.rpc.telemetry.Odometry.child_frame_id:type_name -> mavsdk.rpc.telemetry.Odometry.MavFrame
	142, // 61: mavsdk.rpc.telemetry.Odometry.position_body:type_name -> mavsdk.rpc.telemetry.PositionBody
	129, // 62: mavsdk.rpc.telemetry.Odometry.q:type_name -> mavsdk.rpc.telemetry.Quaternion
	141, // 63: mavsdk.rpc.telemetry.Odometry.velocity_body:type_name -> mavsdk.rpc.telemetry.VelocityBody
	131, // 64: mavsdk.rpc.telemetry.Odometry.angular_velocity_body:type_name -> mavsdk.rpc.telemetry.AngularVelocityBody
	140, // 65: mavsdk.rpc.telemetry.Odometry.pose_covariance:type_name -> mavsdk.rpc.telemetry.Covariance
	140, // 66: mavsdk.rpc.telemetry.Odometry.velocity_covariance:type_name -> mavsdk.rpc.telemetry.Covariance
	130, // 67: mavsdk.rpc.telemetry.DistanceSensor.orientation:type_name -> mavsdk.rpc.telemetry.EulerAngle
	146, // 68: mavsdk.rpc.telemetry.PositionVelocityNed.position:type_name -> mavsdk.rpc.telemetry.PositionNed
	147, // 69: mavsdk.rpc.telemetry.PositionVelocityNed.velocity:type_name -> mavsdk.rpc.telemetry.VelocityNed
	151, // 70: mavsdk.rpc.telemetry.Imu.acceleration_frd:type_name -> mavsdk.rpc.telemetry.AccelerationFrd
	152, // 71: mavsdk.rpc.telemetry.Imu.angular_velocity_frd:type_name -> mavsdk.rpc.telemetry.AngularVelocityFrd
	153, // 72: mavsdk.rpc.telemetry.Imu.magnetic_field_frd:type_name -> mavsdk.rpc.telemetry.MagneticFieldFrd
	7,   // 73: mavsdk.rpc.telemetry.TelemetryResult.result:type_name -> mavsdk.rpc.telemetry.TelemetryResult.Result
	8,   // 74: mavsdk.rpc.telemetry.TelemetryService.SubscribePosition:input_type -> mavsdk.rpc.telemetry.SubscribePositionRequest
	10,  // 75: mavsdk.rpc.telemetry.TelemetryService.SubscribeHome:input_type -> mavsdk.rpc.telemetry.SubscribeHomeRequest
	12,  // 76: mavsdk.rpc.telemetry.TelemetryService.SubscribeInAir:input_type -> mavsdk.rpc.telemetry.SubscribeInAirRequest
	14,  // 77: mavsdk.rpc.telemetry.TelemetryService.SubscribeLandedState:input_type -> mavsdk.rpc.telemetry.SubscribeLandedStateRequest
	16,  // 78: mavsdk.rpc.telemetry.TelemetryService.SubscribeArmed:input_type -> mavsdk.rpc.telemetry.SubscribeArmedRequest
	18,  // 79: mavsdk.rpc.telemetry.TelemetryService.SubscribeVtolState:input_type -> mavsdk.rpc.telemetry.SubscribeVtolStateRequest
	20,  // 80: mavsdk.rpc.telemetry.TelemetryService.SubscribeAttitudeQuaternion:input_type -> mavsdk.rpc.telemetry.SubscribeAttitudeQuaternionRequest
	22,  // 81: mavsdk.rpc.telemetry.TelemetryService.SubscribeAttitudeEuler:input_type -> mavsdk.rpc.telemetry.SubscribeAttitudeEulerRequest
	24,  // 82: mavsdk.rpc.telemetry.TelemetryService.SubscribeAttitudeAngularVelocityBody:input_type -> mavsdk.rpc.telemetry.SubscribeAttitudeAngularVelocityBodyRequest
	26,  // 83: mavsdk.rpc.telemetry.TelemetryService.SubscribeVelocityNed:input_type -> mavsdk.rpc.telemetry.SubscribeVelocityNedRequest
	28,  // 84: mavsdk.rpc.telemetry.TelemetryService.SubscribeGpsInfo:input_type -> mavsdk.rpc.telemetry.SubscribeGpsInfoRequest
	30,  // 85: mavsdk.rpc.telemetry.TelemetryService.SubscribeRawGps:input_type -> mavsdk.rpc.telemetry.SubscribeRawGpsRequest
	32,  // 86: mavsdk.rpc.telemetry.TelemetryService.SubscribeBattery:input_type -> mavsdk.rpc.telemetry.SubscribeBatteryRequest
	34,  // 87: mavsdk.rpc.telemetry.TelemetryService.SubscribeFlightMode:input_type -> mavsdk.rpc.telemetry.SubscribeFlightModeRequest
	36,  // 88: mavsdk.rpc.telemetry.TelemetryService.SubscribeHealth:input_type -> mavsdk.rpc.telemetry.SubscribeHealthRequest
	38,  // 89: mavsdk.rpc.telemetry.TelemetryService.SubscribeRcStatus:input_type -> mavsdk.rpc.telemetry.SubscribeRcStatusRequest
	40,  // 90: mavsdk.rpc.telemetry.TelemetryService.SubscribeStatusText:input_type -> mavsdk.rpc.telemetry.SubscribeStatusTextRequest
	42,  // 91: mavsdk.rpc.telemetry.TelemetryService.SubscribeActuatorControlTarget:input_type -> mavsdk.rpc.telemetry.SubscribeActuatorControlTargetRequest
	44,  // 92: mavsdk.rpc.telemetry.TelemetryService.SubscribeActuatorOutputStatus:input_type -> mavsdk.rpc.telemetry.SubscribeActuatorOutputStatusRequest
	46,  // 93: mavsdk.rpc.telemetry.TelemetryService.SubscribeOdometry:input_type -> mavsdk.rpc.telemetry.SubscribeOdometryRequest
	48,  // 94: mavsdk.rpc.telemetry.TelemetryService.SubscribePositionVelocityNed:input_type -> mavsdk.rpc.telemetry.SubscribePositionVelocityNedRequest
	50,  // 95: mavsdk.rpc.telemetry.TelemetryService.SubscribeGroundTruth:input_type -> mavsdk.rpc.telemetry.SubscribeGroundTruthRequest
	52,  // 96: mavsdk.rpc.telemetry.TelemetryService.SubscribeFixedwingMetrics:input_type -> mavsdk.rpc.telemetry.SubscribeFixedwingMetricsRequest
	54,  // 97: mavsdk.rpc.telemetry.TelemetryService.SubscribeImu:input_type -> mavsdk.rpc.telemetry.SubscribeImuRequest
	56,  // 98: mavsdk.rpc.telemetry.TelemetryService.SubscribeScaledImu:input_type -> mavsdk.rpc.telemetry.SubscribeScaledImuRequest
	58,  // 99: mavsdk.rpc.telemetry.TelemetryService.SubscribeRawImu:input_type -> mavsdk.rpc.telemetry.SubscribeRawImuRequest
	60,  // 100: mavsdk.rpc.telemetry.TelemetryService.SubscribeHealthAllOk:input_type -> mavsdk.rpc.telemetry.SubscribeHealthAllOkRequest
	62,  // 101: mavsdk.rpc.telemetry.TelemetryService.SubscribeUnixEpochTime:input_type -> mavsdk.rpc.telemetry.SubscribeUnixEpochTimeRequest
	64,  // 102: mavsdk.rpc.telemetry.TelemetryService.SubscribeDistanceSensor:input_type -> mavsdk.rpc.telemetry.SubscribeDistanceSensorRequest
	66,  // 103: mavsdk.rpc.telemetry.TelemetryService.SubscribeScaledPressure:input_type -> mavsdk.rpc.telemetry.SubscribeScaledPressureRequest
	68,  // 104: mavsdk.rpc.telemetry.TelemetryService.SubscribeHeading:input_type -> mavsdk.rpc.telemetry.SubscribeHeadingRequest
	70,  // 105: mavsdk.rpc.telemetry.TelemetryService.SubscribeAltitude:input_type -> mavsdk.rpc.telemetry.SubscribeAltitudeRequest
	72,  // 106: mavsdk.rpc.telemetry.TelemetryService.SubscribeWind:input_type -> mavsdk.rpc.telemetry.SubscribeWindRequest
	74,  // 107: mavsdk.rpc.telemetry.TelemetryService.SetRatePosition:input_type -> mavsdk.rpc.telemetry.SetRatePositionRequest
	76,  // 108: mavsdk.rpc.telemetry.TelemetryService.SetRateHome:input_type -> mavsdk.rpc.telemetry.SetRateHomeRequest
	78,  // 109: mavsdk.rpc.telemetry.TelemetryService.SetRateInAir:input_type -> mavsdk.rpc.telemetry.SetRateInAirRequest
	80,  // 110: mavsdk.rpc.telemetry.TelemetryService.SetRateLandedState:input_type -> mavsdk.rpc.telemetry.SetRateLandedStateRequest
	82,  // 111: mavsdk.rpc.telemetry.TelemetryService.SetRateVtolState:input_type -> mavsdk.rpc.telemetry.SetRateVtolStateRequest
	86,  // 112: mavsdk.rpc.telemetry.TelemetryService.SetRateAttitudeQuaternion:input_type -> mavsdk.rpc.telemetry.SetRateAttitudeQuaternionRequest
	84,  // 113: mavsdk.rpc.telemetry.TelemetryService.SetRateAttitudeEuler:input_type -> mavsdk.rpc.telemetry.SetRateAttitudeEulerRequest
	90,  // 114: mavsdk.rpc.telemetry.TelemetryService.SetRateVelocityNed:input_type -> mavsdk.rpc.telemetry.SetRateVelocityNedRequest
	92,  // 115: mavsdk.rpc.telemetry.TelemetryService.SetRateGpsInfo:input_type -> mavsdk.rpc.telemetry.SetRateGpsInfoRequest
	95,  // 116: mavsdk.rpc.telemetry.TelemetryService.SetRateBattery:input_type -> mavsdk.rpc.telemetry.SetRateBatteryRequest
	97,  // 117: mavsdk.rpc.telemetry.TelemetryService.SetRateRcStatus:input_type -> mavsdk.rpc.telemetry.SetRateRcStatusRequest
	99,  // 118: mavsdk.rpc.telemetry.TelemetryService.SetRateActuatorControlTarget:input_type -> mavsdk.rpc.telemetry.SetRateActuatorControlTargetRequest
	101, // 119: mavsdk.rpc.telemetry.TelemetryService.SetRateActuatorOutputStatus:input_type -> mavsdk.rpc.telemetry.SetRateActuatorOutputStatusRequest
	103, // 120: mavsdk.rpc.telemetry.TelemetryService.SetRateOdometry:input_type -> mavsdk.rpc.telemetry.SetRateOdometryRequest
	105, // 121: mavsdk.rpc.telemetry.TelemetryService.SetRatePositionVelocityNed:input_type -> mavsdk.rpc.telemetry.SetRatePositionVelocityNedRequest
	107, // 122: mavsdk.rpc.telemetry.TelemetryService.SetRateGroundTruth:input_type -> mavsdk.rpc.telemetry.SetRateGroundTruthRequest
	109, // 123: mavsdk.rpc.telemetry.TelemetryService.SetRateFixedwingMetrics:input_type -> mavsdk.rpc.telemetry.SetRateFixedwingMetricsRequest
	111, // 124: mavsdk.rpc.telemetry.TelemetryService.SetRateImu:input_type -> mavsdk.rpc.telemetry.SetRateImuRequest
	113, // 125: mavsdk.rpc.telemetry.TelemetryService.SetRateScaledImu:input_type -> mavsdk.rpc.telemetry.SetRateScaledImuRequest
	115, // 126: mavsdk.rpc.telemetry.TelemetryService.SetRateRawImu:input_type -> mavsdk.rpc.telemetry.SetRateRawImuRequest
	117, // 127: mavsdk.rpc.telemetry.TelemetryService.SetRateUnixEpochTime:input_type -> mavsdk.rpc.telemetry.SetRateUnixEpochTimeRequest
	119, // 128: mavsdk.rpc.telemetry.TelemetryService.SetRateDistanceSensor:input_type -> mavsdk.rpc.telemetry.SetRateDistanceSensorRequest
	123, // 129: mavsdk.rpc.telemetry.TelemetryService.SetRateAltitude:input_type -> mavsdk.rpc.telemetry.SetRateAltitudeRequest
	125, // 130: mavsdk.rpc.telemetry.TelemetryService.SetRateHealth:input_type -> mavsdk.rpc.telemetry.SetRateHealthRequest
	121, // 131: mavsdk.rpc.telemetry.TelemetryService.GetGpsGlobalOrigin:input_type -> mavsdk.rpc.telemetry.GetGpsGlobalOriginRequest
	9,   // 132: mavsdk.rpc.telemetry.TelemetryService.SubscribePosition:output_type -> mavsdk.rpc.telemetry.PositionResponse
	11,  // 133: mavsdk.rpc.telemetry.TelemetryService.SubscribeHome:output_type -> mavsdk.rpc.telemetry.HomeResponse
	13,  // 134: mavsdk.rpc.telemetry.TelemetryService.SubscribeInAir:output_type -> mavsdk.rpc.telemetry.InAirResponse
	15,  // 135: mavsdk.rpc.telemetry.TelemetryService.SubscribeLandedState:output_type -> mavsdk.rpc.telemetry.LandedStateResponse
	17,  // 136: mavsdk.rpc.telemetry.TelemetryService.SubscribeArmed:output_type -> mavsdk.rpc.telemetry.ArmedResponse
	19,  // 137: mavsdk.rpc.telemetry.TelemetryService.SubscribeVtolState:output_type -> mavsdk.rpc.telemetry.VtolStateResponse
	21,  // 138: mavsdk.rpc.telemetry.TelemetryService.SubscribeAttitudeQuaternion:output_type -> mavsdk.rpc.telemetry.AttitudeQuaternionResponse
	23,  // 139: mavsdk.rpc.telemetry.TelemetryService.SubscribeAttitudeEuler:output_type -> mavsdk.rpc.telemetry.AttitudeEulerResponse
	25,  // 140: mavsdk.rpc.telemetry.TelemetryService.SubscribeAttitudeAngularVelocityBody:output_type -> mavsdk.rpc.telemetry.AttitudeAngularVelocityBodyResponse
	27,  // 141: mavsdk.rpc.telemetry.TelemetryService.SubscribeVelocityNed:output_type -> mavsdk.rpc.telemetry.VelocityNedResponse
	29,  // 142: mavsdk.rpc.telemetry.TelemetryService.SubscribeGpsInfo:output_type -> mavsdk.rpc.telemetry.GpsInfoResponse
	31,  // 143: mavsdk.rpc.telemetry.TelemetryService.SubscribeRawGps:output_type -> mavsdk.rpc.telemetry.RawGpsResponse
	33,  // 144: mavsdk.rpc.telemetry.TelemetryService.SubscribeBattery:output_type -> mavsdk.rpc.telemetry.BatteryResponse
	35,  // 145: mavsdk.rpc.telemetry.TelemetryService.SubscribeFlightMode:output_type -> mavsdk.rpc.telemetry.FlightModeResponse
	37,  // 146: mavsdk.rpc.telemetry.TelemetryService.SubscribeHealth:output_type -> mavsdk.rpc.telemetry.HealthResponse
	39,  // 147: mavsdk.rpc.telemetry.TelemetryService.SubscribeRcStatus:output_type -> mavsdk.rpc.telemetry.RcStatusResponse
	41,  // 148: mavsdk.rpc.telemetry.TelemetryService.SubscribeStatusText:output_type -> mavsdk.rpc.telemetry.StatusTextResponse
	43,  // 149: mavsdk.rpc.telemetry.TelemetryService.SubscribeActuatorControlTarget:output_type -> mavsdk.rpc.telemetry.ActuatorControlTargetResponse
	45,  // 150: mavsdk.rpc.telemetry.TelemetryService.SubscribeActuatorOutputStatus:output_type -> mavsdk.rpc.telemetry.ActuatorOutputStatusResponse
	47,  // 151: mavsdk.rpc.telemetry.TelemetryService.SubscribeOdometry:output_type -> mavsdk.rpc.telemetry.OdometryResponse
	49,  // 152: mavsdk.rpc.telemetry.TelemetryService.SubscribePositionVelocityNed:output_type -> mavsdk.rpc.telemetry.PositionVelocityNedResponse
	51,  // 153: mavsdk.rpc.telemetry.TelemetryService.SubscribeGroundTruth:output_type -> mavsdk.rpc.telemetry.GroundTruthResponse
	53,  // 154: mavsdk.rpc.telemetry.TelemetryService.SubscribeFixedwingMetrics:output_type -> mavsdk.rpc.telemetry.FixedwingMetricsResponse
	55,  // 155: mavsdk.rpc.telemetry.TelemetryService.SubscribeImu:output_type -> mavsdk.rpc.telemetry.ImuResponse
	57,  // 156: mavsdk.rpc.telemetry.TelemetryService.SubscribeScaledImu:output_type -> mavsdk.rpc.telemetry.ScaledImuResponse
	59,  // 157: mavsdk.rpc.telemetry.TelemetryService.SubscribeRawImu:output_type -> mavsdk.rpc.telemetry.RawImuResponse
	61,  // 158: mavsdk.rpc.telemetry.TelemetryService.SubscribeHealthAllOk:output_type -> mavsdk.rpc.telemetry.HealthAllOkResponse
	63,  // 159: mavsdk.rpc.telemetry.TelemetryService.SubscribeUnixEpochTime:output_type -> mavsdk.rpc.telemetry.UnixEpochTimeResponse
	65,  // 160: mavsdk.rpc.telemetry.TelemetryService.SubscribeDistanceSensor:output_type -> mavsdk.rpc.telemetry.DistanceSensorResponse
	67,  // 161: mavsdk.rpc.telemetry.TelemetryService.SubscribeScaledPressure:output_type -> mavsdk.rpc.telemetry.ScaledPressureResponse
	69,  // 162: mavsdk.rpc.telemetry.TelemetryService.SubscribeHeading:output_type -> mavsdk.rpc.telemetry.HeadingResponse
	71,  // 163: mavsdk.rpc.telemetry.TelemetryService.SubscribeAltitude:output_type -> mavsdk.rpc.telemetry.AltitudeResponse
	73,  // 164: mavsdk.rpc.telemetry.TelemetryService.SubscribeWind:output_type -> mavsdk.rpc.telemetry.WindResponse
	75,  // 165: mavsdk.rpc.telemetry.TelemetryService.SetRatePosition:output_type -> mavsdk.rpc.telemetry.SetRatePositionResponse
	77,  // 166: mavsdk.rpc.telemetry.TelemetryService.SetRateHome:output_type -> mavsdk.rpc.telemetry.SetRateHomeResponse
	79,  // 167: mavsdk.rpc.telemetry.TelemetryService.SetRateInAir:output_type -> mavsdk.rpc.telemetry.SetRateInAirResponse
	81,  // 168: mavsdk.rpc.telemetry.TelemetryService.SetRateLandedState:output_type -> mavsdk.rpc.telemetry.SetRateLandedStateResponse
	83,  // 169: mavsdk.rpc.telemetry.TelemetryService.SetRateVtolState:output_type -> mavsdk.rpc.telemetry.SetRateVtolStateResponse
	87,  // 170: mavsdk.rpc.telemetry.TelemetryService.SetRateAttitudeQuaternion:output_type -> mavsdk.rpc.telemetry.SetRateAttitudeQuaternionResponse
	85,  // 171: mavsdk.rpc.telemetry.TelemetryService.SetRateAttitudeEuler:output_type -> mavsdk.rpc.telemetry.SetRateAttitudeEulerResponse
	91,  // 172: mavsdk.rpc.telemetry.TelemetryService.SetRateVelocityNed:output_type -> mavsdk.rpc.telemetry.SetRateVelocityNedResponse
	93,  // 173: mavsdk.rpc.telemetry.TelemetryService.SetRateGpsInfo:output_type -> mavsdk.rpc.telemetry.SetRateGpsInfoResponse
	96,  // 174: mavsdk.rpc.telemetry.TelemetryService.SetRateBattery:output_type -> mavsdk.rpc.telemetry.SetRateBatteryResponse
	98,  // 175: mavsdk.rpc.telemetry.TelemetryService.SetRateRcStatus:output_type -> mavsdk.rpc.telemetry.SetRateRcStatusResponse
	100, // 176: mavsdk.rpc.telemetry.TelemetryService.SetRateActuatorControlTarget:output_type -> mavsdk.rpc.telemetry.SetRateActuatorControlTargetResponse
	102, // 177: mavsdk.rpc.telemetry.TelemetryService.SetRateActuatorOutputStatus:output_type -> mavsdk.rpc.telemetry.SetRateActuatorOutputStatusResponse
	104, // 178: mavsdk.rpc.telemetry.TelemetryService.SetRateOdometry:output_type -> mavsdk.rpc.telemetry.SetRateOdometryResponse
	106, // 179: mavsdk.rpc.telemetry.TelemetryService.SetRatePositionVelocityNed:output_type -> mavsdk.rpc.telemetry.SetRatePositionVelocityNedResponse
	108, // 180: mavsdk.rpc.telemetry.TelemetryService.SetRateGroundTruth:output_type -> mavsdk.rpc.telemetry.SetRateGroundTruthResponse
	110, // 181: mavsdk.rpc.telemetry.TelemetryService.SetRateFixedwingMetrics:output_type -> mavsdk.rpc.telemetry.SetRateFixedwingMetricsResponse
	112, // 182: mavsdk.rpc.telemetry.TelemetryService.SetRateImu:output_type -> mavsdk.rpc.telemetry.SetRateImuResponse
	114, // 183: mavsdk.rpc.telemetry.TelemetryService.SetRateScaledImu:output_type -> mavsdk.rpc.telemetry.SetRateScaledImuResponse
	116, // 184: mavsdk.rpc.telemetry.TelemetryService.SetRateRawImu:output_type -> mavsdk.rpc.telemetry.SetRateRawImuResponse
	118, // 185: mavsdk.rpc.telemetry.TelemetryService.SetRateUnixEpochTime:output_type -> mavsdk.rpc.telemetry.SetRateUnixEpochTimeResponse
	120, // 186: mavsdk.rpc.telemetry.TelemetryService.SetRateDistanceSensor:output_type -> mavsdk.rpc.telemetry.SetRateDistanceSensorResponse
	124, // 187: mavsdk.rpc.telemetry.TelemetryService.SetRateAltitude:output_type -> mavsdk.rpc.telemetry.SetRateAltitudeResponse
	126, // 188: mavsdk.rpc.telemetry.TelemetryService.SetRateHealth:output_type -> mavsdk.rpc.telemetry.SetRateHealthResponse
	122, // 189: mavsdk.rpc.telemetry.TelemetryService.GetGpsGlobalOrigin:output_type -> mavsdk.rpc.telemetry.GetGpsGlobalOriginResponse
